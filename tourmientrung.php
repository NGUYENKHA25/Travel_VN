...
echo "<h2>Du Lịch Miền Trung - Thiên Đường Của Biển </h2>";
...
$sql = "SELECT * FROM tourviet_data WHERE tenvung ='TMT' LIMIT $start, $limit";

$result = mysqli_query($conn, $sql);

// lấy số sản phẩm từ cơ sở dữ liệu
$sql_count = "SELECT COUNT(*) AS count FROM tourviet_data WHERE tenvung ='TMT' ";
