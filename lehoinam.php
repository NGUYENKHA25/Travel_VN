...
<div class="bodyhead">
    <h2 style="font-size: 50px; color: darkred;">Những lễ hội đặc trưng miền Nam</h2>
</div>
...
$sql = "SELECT * FROM lehoi where tenvung = 'VMN' LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// lấy số sản phẩm từ cơ sở dữ liệu
$sql_count = "SELECT COUNT(*) AS count FROM lehoi where tenvung = 'VMN'";
